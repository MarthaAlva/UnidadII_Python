...
class Ui_MainWindow(object):
    ...
    def sql_table_view_model(self):
            ...
            self.model.setHeaderData(3, QtCore.Qt.Horizontal, "Supplier")
            self.model.setHeaderData(4, QtCore.Qt.Horizontal, "other_details")
    ...
    def create_DB(self):
            ...
            query.exec_("create table detalle(ID int primary key,"
                            "Type string(20), Name sring(20), Supplier string(20), other_details string(20), senseCam string(20))")
            query.exec_("insert into detalle values(2, 'Test', 'prueba', 'intento', 'Test2', 'pruebaP' )")
